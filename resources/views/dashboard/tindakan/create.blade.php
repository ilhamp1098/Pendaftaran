...
<form method="post" action="/dashboard/tindakan" class="mb-5" enctype="multipart/form-data">
    @csrf
<div class="col-md-6">
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control @error('nama_tindakan') is-invalid @enderror" name="nama_tindakan" id="nama_tindakan"  required autofocus value="{{old('nama_tindakan')}}">
    @error('nama_tindakan')
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control @error('tarif_tindakan') is-invalid @enderror" name="tarif_tindakan" id="tarif_tindakan"  required autofocus value=" {{old('tarif_tindakan')}}">
